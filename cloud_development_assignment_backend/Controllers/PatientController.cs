...
namespace cloud_development_assignment_backend.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        // GET: api/Patient/personal/{patientId}
        [HttpGet("personal/{patientId}")]
        public ActionResult<object> GetPatientPersonalInfo(int patientId)
        {
            var user = _context.Users.FirstOrDefault(u => u.Id == patientId && u.Role == "Patient");
            if (user == null)
        ...
        // GET: api/Patient/personal
        [HttpGet("personal")]
        public ActionResult<IEnumerable<object>> GetAllPatientsPersonalInfo()
        {
